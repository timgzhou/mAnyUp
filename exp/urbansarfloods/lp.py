...
Head (pa2px, per-pixel):
    ...
    exp/pastis/lp_cached_features.py but on concatenated pre/post features.
...
Runs in the OlmoEarth venv (for segmentation_metrics):
    ...
    python -u exp/urbansarfloods/lp.py --features usf_base_s1_ps4_res20
"""
import os
import sys
...
def main() -> None:
    ...
    p.add_argument("--viz_out", default=None,
                   help="prediction PNG path; default auto-names per config: results/urbansarfloods/<features>_<head>.png")
    p.add_argument("--results_csv", default="results/urbansarfloods/lp.csv",
    ...
    if args.viz_out is None:
        ...
        args.viz_out = f"results/urbansarfloods/{args.features}_{args.head}{wc}.png"
