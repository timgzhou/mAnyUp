...
Reads the 64x64 sub-tiles from exp/urbansarfloods/prep_tiles.py, runs the FROZEN OlmoEarth
...
Runs in the OlmoEarth venv, on GPU (salloc):
    ...
    python -u exp/urbansarfloods/extract_features.py --splits train,valid
"""
import os
import sys
...
from exp.urbansarfloods.dataset import sar8_to_olmoearth_sample
