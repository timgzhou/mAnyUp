"""Visualize results/pastis/lp_olmoearth_pastis.csv: one subplot per feature set, test_miou on y,
...
def main() -> None:
    ...
    ap.add_argument("--csv", default="results/pastis/lp_olmoearth_pastis.csv")
