...
tile_size.
    ...
    python plot_urbansarfloods_csv.py [--csv results/urbansarfloods/lp.csv] [--out results/urbansarfloods/f1.png]
"""
import argparse
import csv
...
def main():
    ...
    ap.add_argument("--csv", default="results/urbansarfloods/lp.csv")
    ap.add_argument("--out", default="results/urbansarfloods/f1.png")
    args = ap.parse_args()
