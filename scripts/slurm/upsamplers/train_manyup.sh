...
#
# Examples:
#   sbatch scripts/slurm/upsamplers/train_manyup.sh                                             # defaults: ps4_tile4 -> ps1_tile64
#   sbatch --export=ALL,LR_CFG=oe_base_s2_ps4_tile32,HR_CFG=oe_base_s2_ps1_tile1 scripts/slurm/upsamplers/train_manyup.sh
#   sbatch --export=ALL,LR_CFG=oe_base_s2_ps2_tile8,HR_CFG=oe_base_s2_ps1_tile64,EPOCHS=20 scripts/slurm/upsamplers/train_manyup.sh
#   sbatch --export=ALL,EXTRA="--no-proj_head --no-linear_baseline" scripts/slurm/upsamplers/train_manyup.sh
...
python -u -m exp.upsamplers.train_manyup $ARGS
STATUS=$?
