...
There is no saved pa2pa checkpoint in checkpoints/ -- lp_on_cached_features.py trains heads and
...
UPA/UPMA are imported from compare_upa_anyup_oeps1.py (single source of truth -- no duplicated
kernel code).
...
def main():
    ...
    from lp_on_cached_features import (CachedFeatureDataset, NUM_CLASSES,
