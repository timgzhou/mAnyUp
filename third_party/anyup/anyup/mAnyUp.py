...
class mAnyUp(nn.Module):
    def __init__(
        ...
        self.transform = nn.Sequential(
            *[ResBlock(feat_dim, feat_dim, kernel_size=1) for _ in range(transform_depth)])
    ...
    def upsample(self, enc_img, feats, out_size, vis_attn=False, q_chunk_size=None):
        ...
        return self.transform(self.cross_decode(q, k, v, vis_attn=vis_attn, q_chunk_size=q_chunk_size))
