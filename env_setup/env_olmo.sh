# Separate venv for OlmoEarth finetuning (exp/pastis/prepare_data.py,
# exp/pastis/finetune_olmoearth.py). Kept apart from ./env because olmoearth-pretrain
# pins torch<2.8, which conflicts with ./env's torch 2.12 (reference/dead_code/pastis.py / torchgeo).
#
...
# fails to import. The finetune scripts also import exp/common/olmo_bootstrap first,
